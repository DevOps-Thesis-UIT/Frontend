...
function Home() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://a833b046604d845b58a9e85dd542ac9a-537800968.us-east-1.elb.amazonaws.com/products", {
        headers: {
  ...
  const handleSelectChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedCategory === "idle") {
      ...
      fetch(`http://a833b046604d845b58a9e85dd542ac9a-537800968.us-east-1.elb.amazonaws.com/filter/category/${selectedCategory}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
